...
class GraphDataset(DGLDataset):
    ...
    process构图：
        ...
        边特征包括：
            ...
            target_train_mask: 来自target的训练集
            target_val_mask: 来自target的验证集
    ...
    def process(self):
        ...
        reverse_source["source_reverse_mask"] = 1
        reverse_source["source_forward_mask"] = 0
        self.source_event["source_reverse_mask"] = 0
        self.source_event["source_forward_mask"] = 1
        ...
        all_source_event["source_events"] = all_source_event.event_id.apply(lambda x: to_one_hot(x.tolist(), 2*source_event_cnt))
        ...
        all_source_event = all_source_event[["voter_id", "inviter_id", "source_train_mask", "source_val_mask",
                                             ...
                                             "source_reverse_mask", "source_forward_mask"]]
        ...
        # source_forward_cnt = all_source_event["source_forward_mask"].sum()
        # source_reverse_cnt = all_source_event["source_reverse_mask"].sum()
        ...
        self.target_event["source_reverse_mask"] = 0
        self.target_event["source_forward_mask"] = 0
        ...
        self.graph.edata['source_reverse_mask'] = torch.tensor(np.array(events["source_reverse_mask"].tolist()), dtype=torch.bool)
